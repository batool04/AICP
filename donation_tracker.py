# -*- coding: utf-8 -*-
"""Donation_Tracker.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vBn2fFWcpPoIvNET_CczvH2vGvfzoweu
"""

#The manager of a supermarket needs a program to record donations to charity. Each customer has the choice of three charities to donate to,
#and 1% of their shopping bill will be donated to the chosen charity
...
#To find the grand total donated to charity:
